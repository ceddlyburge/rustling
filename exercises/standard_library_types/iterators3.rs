...
mod tests {
    ...
    fn result_with_list() {
        ...
        let x = division_results.collect::<Result<Vec<i32>, DivisionError>>(); // turbofish syntax i think
    ...
    fn list_of_results() {
        ...
        // could also turbfish here, probably useful when chaining a lot of stuff together
